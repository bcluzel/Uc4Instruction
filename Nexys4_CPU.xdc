...
set_property PACKAGE_PIN U9 [get_ports valid_saisie]
set_property IOSTANDARD LVCMOS33 [get_ports valid_saisie]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
##set_property PACKAGE_PIN U8 [get_ports pdb[1]]
##set_property IOSTANDARD LVCMOS33 [get_ports pdb[1]]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
##set_property PACKAGE_PIN R7 [get_ports pdb[2]]
##set_property IOSTANDARD LVCMOS33 [get_ports pdb[2]]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
##set_property PACKAGE_PIN R6 [get_ports pdb[3]]
##set_property IOSTANDARD LVCMOS33 [get_ports pdb[3]]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
##set_property PACKAGE_PIN R5 [get_ports pdb[4]]
##set_property IOSTANDARD LVCMOS33 [get_ports pdb[4]]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
##set_property PACKAGE_PIN V7 [get_ports pdb[5]]
##set_property IOSTANDARD LVCMOS33 [get_ports pdb[5]]
##Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
##set_property PACKAGE_PIN V6 [get_ports pdb[6]]
##set_property IOSTANDARD LVCMOS33 [get_ports pdb[6]]
##Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
##set_property PACKAGE_PIN V5 [get_ports pdb[7]]
##set_property IOSTANDARD LVCMOS33 [get_ports pdb[7]]
...
set_property PACKAGE_PIN L3 [get_ports {Sevenseg[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Sevenseg[0]}]
##Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {Sevenseg[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Sevenseg[1]}]
##Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {Sevenseg[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Sevenseg[2]}]
##Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
set_property PACKAGE_PIN L4 [get_ports {Sevenseg[3]}]
...
set_property PACKAGE_PIN M2 [get_ports {Sevenseg[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Sevenseg[5]}]
##Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {Sevenseg[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Sevenseg[6]}]
##Bank = 34, Pin name = IO_L16P_T2_34,						Sch name = DP
set_property PACKAGE_PIN M4 [get_ports {Sevenseg[7]}]
